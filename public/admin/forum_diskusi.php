...
// Check if user is logged in and has an allowed role (teacher or admin)
if (!isset($_SESSION['user']['role']) || ($_SESSION['user']['role'] !== 'guru' && $_SESSION['user']['role'] !== 'admin')) {
    die("Anda tidak memiliki izin untuk mengakses halaman ini. (Hanya Guru dan Admin)");
}
